 ...
 *         Time: 4:34 PM
 */
public class TipoPagoComboBoxModel implements ComboBoxModel {
     ...
     * Constructor
     *
     * @param tiposPagos, List<Map>
     */
    public TipoPagoComboBoxModel(TiposPago[] tiposPagos) {

        for (TiposPago tipoPago: tiposPagos) {
            data.add(new ComboBoxModelObject(tipoPago.getValue(), tipoPago.toString(), tipoPago));
        }
