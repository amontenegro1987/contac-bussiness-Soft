 ...
 * Time: 08:10 AM
 */
public class TipoTasaCambioComboBoxModel implements ComboBoxModel {
     ...
     * Constructor
     *
     * @param tiposTasaCambio, List<Map>
     */
    public TipoTasaCambioComboBoxModel(TiposTasaCambio[] tiposTasaCambio) {

        for (TiposTasaCambio tipoTasaCambio : tiposTasaCambio) {
            data.add(new ComboBoxModelObject(tipoTasaCambio.getValue(), tipoTasaCambio.toString(), tipoTasaCambio));
        }
