...
/**
 * Copyright 201 Contac Business Software. All rights reserved.
 *
 * @author Alejandro Montenegro
 *         Date: 30/08/2014
 *         Time: 12:51 PM
 */
public class TipoTarjetaComboBoxModel implements ComboBoxModel {
     ...
     * Constructor
     *
     * @param tiposTarjetas, List<Map>
     */
    public TipoTarjetaComboBoxModel(TiposTarjeta[] tiposTarjetas) {

        for (TiposTarjeta tipoTarjeta : tiposTarjetas) {
            data.add(new ComboBoxModelObject(tipoTarjeta.getValue(), tipoTarjeta.toString(), tipoTarjeta));
        }
