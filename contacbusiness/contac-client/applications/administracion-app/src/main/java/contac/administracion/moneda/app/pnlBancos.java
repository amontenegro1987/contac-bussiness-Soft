 ...
 * pnlBancos.java
 *
 * Created on 02-11-2012, 11:41:44 PM
 */
 ...
 * @author EMontenegro
 */
public class pnlBancos extends GenericPanel {
    ...
    /**
     * Creates new form pnlBancos
     */
    public pnlBancos(GenericFrame frame) {

        //Call super constructor
        super(frame, "Bancos", "Bancos", true, "contac/administracion/app/mensajes/Mensajes",
                new Locale("es", "NIC"));
        ...
        //Init registros
        controller.initRegistrosBancos();
    ...
    public void initValues() {
        ...
        //Configuramos table model
        bancoBeanTableModel = new BeanTableModel<Banco>(Banco.class, controller.getBancos());
        bancoBeanTableModel.setModelEditable(false);
        tblBancos.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
        tblBancos.setModel(bancoBeanTableModel);
        tblBancos.setRowSelectionAllowed(true);

        //Obteniendo table column model y removiendo columnas innecesarias
        TableColumnModel columnModel = tblBancos.getColumnModel();
        String[] columnsRemove = new String[]{"Id", "Compania", "Ctime", "Cuser", "Mtime", "Muser"};
    ...
    private void initComponents() {
        ...
        pnlAdmonBancos = new javax.swing.JPanel();
        ...
        header.setTitle(bundle.getString("CONTAC.FORM.BANCOS.TITLE")); // NOI18N
        header.setTitleForeground(new java.awt.Color(255, 153, 0));
        add(header, java.awt.BorderLayout.NORTH);

        pnlAdmonBancos.setLayout(new java.awt.BorderLayout());

        scrollCompania.setPreferredSize(new java.awt.Dimension(452, 420));

        tblBancos.setMinimumSize(new java.awt.Dimension(60, 90));
        tblBancos.setPreferredSize(new java.awt.Dimension(300, 280));
        tblBancos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblBancosMouseClicked(evt);
            }
        });
        scrollCompania.setViewportView(tblBancos);

        pnlAdmonBancos.add(scrollCompania, java.awt.BorderLayout.CENTER);
        ...
        pnlAdmonBancos.add(tbAcciones, java.awt.BorderLayout.PAGE_START);

        add(pnlAdmonBancos, java.awt.BorderLayout.CENTER);
    }// </editor-fold>//GEN-END:initComponents

    private void tblBancosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBancosMouseClicked

        //Getting selected row
        rowSelected = tblBancos.getSelectedRow();
        bancoSelected = (Banco) ((BeanTableModel) tblBancos.getModel()).getRow(rowSelected);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        //Open Admon bancos
        new pnlAdmonBancos(mdi, true, null);

        //Actualizar registro de bancos
        actualizarRegistroBancos();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        //Open Admon bancos
        new pnlAdmonBancos(mdi, true, bancoSelected);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            ...
            if (confirmation) {
                ...
                //Validar que banco se encuentre seleccionado
                ...
                //Remover banco
                controller.setBanco(bancoSelected);
     ...
     */
    private void actualizarRegistroBancos() {

        try {
            //Actualiar registro de bancos
            controller.actualizarRegistrosBancos();

            //Actualizar tblMonedas
            ((BeanTableModel) tblBancos.getModel()).fireTableDataChanged();
    ...
    private javax.swing.JPanel pnlAdmonBancos;
    ...
    private BeanTableModel<Banco> bancoBeanTableModel;
