 ...
 * pnlTasasCambio.java
 *
 * Created on 02-11-2012, 11:46:12 PM
 */
...
import contac.commons.form.render.FechaFormatRenderer;
import contac.commons.form.render.MonedaFormatRenderer;
import contac.commons.form.render.TiposTasasCambioRenderer;
 ...
 * @author EMontenegro
 */
public class pnlTasasCambio extends GenericPanel {
    ...
    /**
     * Creates new form pnlTasasCambio
     */
    public pnlTasasCambio(GenericFrame frame) {

        //Call super constructor
        super(frame, "Tasas de Cambio", "Tasas de Cambio", true, "contac/administracion/app/mensajes/Mensajes",
                new Locale("es", "NIC"));

        //Init controller
        controller = new TasasCambioController();

        //Init registros tasas de cambio
        controller.initRegistrosTasasCambio();
    ...
    public void initValues() {
        ...
        //Row selection allow
        this.tasaCambioSelected = null;

        //Configure table model
        tasaCambioBeanTableModel = new BeanTableModel<TasaCambio>(TasaCambio.class, controller.getTasasCambio());
        tasaCambioBeanTableModel.setModelEditable(false);
        tblTasasCambio.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
        tblTasasCambio.setModel(tasaCambioBeanTableModel);
        tblTasasCambio.setRowSelectionAllowed(true);

        //Obteniendo table column model y removiendo columnas innecesarias
        TableColumnModel columnModel = tblTasasCambio.getColumnModel();
        String[] columnsRemove = new String[]{"Id", "Moneda Referencia", "Banco", "Ctime", "Cuser", "Mtime", "Muser"};
        ...
        TiposTasasCambioRenderer tiposTasasCambioRenderer = new TiposTasasCambioRenderer();
        columnModel.getColumn(0).setCellRenderer(tiposTasasCambioRenderer);
        ...
        columnModel.getColumn(1).setCellRenderer(decimalFormatRenderer);

        FechaFormatRenderer fechaFormatRenderer = new FechaFormatRenderer();
        fechaFormatRenderer.setHorizontalAlignment(JLabel.CENTER);
        columnModel.getColumn(2).setCellRenderer(fechaFormatRenderer);

        MonedaFormatRenderer monedaFormatRenderer = new MonedaFormatRenderer();
        columnModel.getColumn(3).setCellRenderer(monedaFormatRenderer);
    ...
    private void initComponents() {
        ...
        pnlAdmonTasasCambio = new javax.swing.JPanel();
        scrollCompania = new javax.swing.JScrollPane();
        tblTasasCambio = new javax.swing.JTable();
        ...
        header.setTitle(bundle.getString("CONTAC.FORM.TASASCAMBIO.TITLE")); // NOI18N
        header.setTitleForeground(new java.awt.Color(255, 153, 0));
        add(header, java.awt.BorderLayout.NORTH);

        pnlAdmonTasasCambio.setLayout(new java.awt.BorderLayout());

        scrollCompania.setPreferredSize(new java.awt.Dimension(452, 420));

        tblTasasCambio.setMinimumSize(new java.awt.Dimension(60, 90));
        tblTasasCambio.setPreferredSize(new java.awt.Dimension(300, 280));
        tblTasasCambio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTasasCambioMouseClicked(evt);
            }
        });
        scrollCompania.setViewportView(tblTasasCambio);

        pnlAdmonTasasCambio.add(scrollCompania, java.awt.BorderLayout.CENTER);
        ...
        pnlAdmonTasasCambio.add(tbAcciones, java.awt.BorderLayout.PAGE_START);

        add(pnlAdmonTasasCambio, java.awt.BorderLayout.CENTER);
    }// </editor-fold>//GEN-END:initComponents

    private void tblTasasCambioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTasasCambioMouseClicked

        //Getting selected row
        rowSelected = tblTasasCambio.getSelectedRow();
        tasaCambioSelected = (TasaCambio) (((BeanTableModel) tblTasasCambio.getModel()).getRow(rowSelected));

    }//GEN-LAST:event_tblTasasCambioMouseClicked

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed

        //Open Admon tasa cambio
        new pnlAdmonTasasCambio(mdi, true, null);

        //Actualizar registro de tasas de cambio
        actualizarRegistrosTasasCambio();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        //Open Admon tasa cambio
        new pnlAdmonTasasCambio(mdi, true, tasaCambioSelected);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        try {
            ...
            controller.actualizarRegistroTasasCambio();

            //Actualizar tblMonedas
            ((BeanTableModel) tblTasasCambio.getModel()).fireTableDataChanged();
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            ...
            if (confirmation) {
                ...
                //Validar que tasa cambio se encuentre seleccionado
                if (tasaCambioSelected == null)
                    JOptionErrorPane.showMessageError(null, messageBundle.getString("CONTAC.FORM.MSG.ERROR.REGISTRO"),
                            messageBundle.getString("CONTAC.FORM.MSG.SELECCIONA.REGISTRO"));

                //Remover tasa de cambio
                controller.setTasaCambio(tasaCambioSelected);
    ...
    /**
     * This method is called from within action performed to update list of objects
     */
    private void actualizarRegistrosTasasCambio() {
        try {

            //Actualizar registro de tasas de cambio
            controller.actualizarRegistroTasasCambio();

            //Actualizar tblTasasCambio
            ((BeanTableModel) tblTasasCambio.getModel()).fireTableDataChanged();
    ...
    private javax.swing.JPanel pnlAdmonTasasCambio;
    private javax.swing.JScrollPane scrollCompania;
    private javax.swing.JToolBar tbAcciones;
    private javax.swing.JTable tblTasasCambio;
    // End of variables declaration//GEN-END:variables

    private BeanTableModel<TasaCambio> tasaCambioBeanTableModel;
