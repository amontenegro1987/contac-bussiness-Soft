 ...
 * @author amortiz
 */
public class pnlTotalOrdenCompra extends JDialog {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(pnlTotalOrdenCompra.class);
    ...
    /**
     * Creates new form pnlTotalOrdenCompra
     */
    public pnlTotalOrdenCompra(GenericFrame frame, ProformaClienteController controller, boolean modal) {
