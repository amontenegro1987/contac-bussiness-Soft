...
/**
 * Representa un Articulo de Orden de Compra
 */
@Entity
@Table(name = "FAC_DETALLE_ORDEN_COMPRA")
@EntityListeners(Audit.class)
public class ArticuloOrdenCompra extends Articulo implements java.io.Serializable {
    ...
    @JoinColumn(name = "N_ID_ORDEN_COMPRA", nullable = false)
    ...
    @Column(name = "N_NO_ORDEN_COMPRA", nullable = false)
