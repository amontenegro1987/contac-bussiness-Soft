...
/**
 * Representa un DocumentoOrdenCompra abstract entity business
 * <p/>
 ...
 */
@MappedSuperclass
public abstract class DocumentoOrdenCompra implements java.io.Serializable {
    ...
    @JoinColumn(name = "N_ID_PROVEEDOR", referencedColumnName = "N_ID", nullable = false)
    ...
    @Column(name = "C_NOMBRE_PROVEEDOR", nullable = false)
    ...
    @Column(name = "D_FECHAREQUERIDA", nullable = false)
